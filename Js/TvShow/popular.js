...
var url = "https://api.themoviedb.org/3/tv/popular?api_key="+api_key+"&language=en-US";
...
xmlhttp.onreadystatechange = function () {
    if (this.readyState === 4 && this.status === 200) {
        ...
        for (var i = 0; i < obj.results.length; i++) {
            ...
            item += '</div>';
            item += '<div class="info">';
            item += '<a href="../../Blade/Tv/Detail.html?id='+obj.results[i].id +'"> <h3 class="title-movie" > '+obj.results[i].name +'</h3></a>';
