...
function movie_detail(id) {
    ...
    var url = "https://api.themoviedb.org/3/tv/" + id + "?api_key=" + api_key + "&append_to_response=credits";
    ...
    xmlhttp.onreadystatechange = function () {
        if (this.readyState === 4 && this.status === 200) {
            ...
            var released = obj.last_air_date;
            ...
            detail_item += '<h1>' + obj.name + '&nbsp;<span class="released">(' + released.split("-", 1) + ')</span></h1>';
